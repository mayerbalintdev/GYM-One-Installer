...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST["servername"]) && isset($_POST["username"]) && isset($_POST["password"]) && isset($_POST["dbname"])) {
        ...
        try {
            ...
            file_put_contents($log_file, "[" . date("Y-m-d H:i:s") . "] [STAGE2]" . $success_message . PHP_EOL, FILE_APPEND);
            ...
            file_put_contents($log_file, "[" . date("Y-m-d H:i:s") . "] [STAGE2]" . $error_message . PHP_EOL, FILE_APPEND);
